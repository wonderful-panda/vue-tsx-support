...
function createModifier(filters: EventFilter[]): Modifier {
  ...
  defineChildModifier(
    ...
    filters,
    "del",
    (e: any) => e.keyCode === 8 || e.keyCode === 46
  );
  ...
  defineChildModifier(
    ...
    filters,
    "left",
    (e: any) => e.keyCode === 37 || e.button === 0
  );
  defineChildModifier(
    m,
    filters,
    "right",
    (e: any) => e.keyCode === 39 || e.button === 2
  );
  ...
  defineChildModifier(
    ...
    filters,
    "noctrl",
    (e: any) => e.ctrlKey !== undefined && !e.ctrlKey
  );
  defineChildModifier(
    m,
    filters,
  ...
  defineChildModifier(
    ...
    filters,
    "noalt",
    (e: any) => e.altKey !== undefined && !e.altKey
  );
  defineChildModifier(
    m,
    filters,
    "nometa",
    (e: any) => e.metaKey !== undefined && !e.metaKey
  );
