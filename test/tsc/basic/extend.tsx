...
function by_createComponent() {
    ...
    // NG
    <Base />;   //// TS2322 | TS2326: 'foo' is missing
    // OK
    <Base foo="foo" onOk={ noop } />;
    // NG
    <Base foo="foo" bar="bar" />;   //// TS2322 | TS2339: Property 'bar' does not exist
    // NG
    <Base foo="foo" onErr={ noop } />;   //// TS2322 | TS2339: Property 'onErr' does not exist
    ...
    // NG
    <Extend foo="foo" />;   //// TS2322 | TS2326: 'bar' is missing
    // NG
    <Extend bar="bar" />;   //// TS2322 | TS2326: 'foo' is missing
