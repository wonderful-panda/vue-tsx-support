...
function componentFactoryOf() {
    ...
    <MyComponent scopedSlots={{}} />;           //// TS2322 | TS2326 | TS2769: Property 'content' is missing
...
function optionalScopedSlot() {
    ...
    <MyComponent scopedSlots={{ optional: p => p.toString() }} />; //// TS2322 | TS2769: 'required' is missing
}
